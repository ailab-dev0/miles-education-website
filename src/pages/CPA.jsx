...
function MainPageBanner() {
  ...
  return (
    <div className="w-full bg-center relative" style={{ minHeight: "580px", contain: "layout" }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative px-5 lg:py-10">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5 relative py-6">
          <div className="flex flex-col items-center md:items-start gap-4 sm:gap-6 lg:pt-10">
            <div className="md:text-left text-center md:z-20">
              ...
              <span className="md:text-[36px] text-2xl font-semibold leading-normal tracking-[-1.44px] bg-[linear-gradient(88deg,_#39F_73.02%,_#FFB801_90.73%)] bg-clip-text text-transparent relative">
                Earn 50L+ per annum
              </span>
            </div>
          ...
          <div className="w-full relative flex items-center justify-center lg:justify-end z-[1] bottom-1 lg:pt-12">
            <div className="w-[400px] p-4 border border-white rounded-2xl bg-gradient-to-b from-white/30 to-blue-400/30 shadow-[0px_0px_14px_0px_rgba(4,84,175,0.29)] backdrop-blur-[28px] relative">
              <img
          ...
          <div className="m-2 md:m-3 rounded-[12px]">
            <div className="bg-[#F8F8F8] border border-[#EDEDF0] rounded-lg p-3">
              ...
              <div className="mt-4 md:mt-6 justify-center hidden md:flex">
                <img src={logoPanelDeskSrc} alt={logoPanelDeskAlt} className="h-12 w-auto object-contain" />
              </div>
              <div className="mt-3 justify-center flex md:hidden">
                <img src={logoPanelMobSrc} alt={logoPanelMobAlt} className="w-auto object-contain" />
              </div>
            </div>
            <div className="mt-4 justify-center overflow-hidden hidden md:flex">
              <img src={partnerImage} alt="Partner video" className="cursor-pointer md:hover:scale-105 ease-in-out duration-300 w-full object-contain" onClick={() => onImageClick(code)} />
            </div>
            <div className="mt-3 justify-center overflow-hidden flex md:hidden">
              <img src={partnerImageMobile} alt="Partner video" className="cursor-pointer md:hover:scale-105 ease-in-out duration-300 w-auto object-contain" onClick={() => onImageClick(code)} />
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <>
      <section className="w-full bg-white relative" aria-labelledby="placement-partners-heading" style={{ minHeight: "600px" }}>
        <div className="hidden md:block absolute inset-0" style={{ contain: "layout style paint" }}>
          <img src="https://ik.imagekit.io/mileseducation/miles_website/accounting/cpa/LeadingGlobalBG.png?tr=f-webp" alt="Background graphic for Miles Education" className="absolute inset-0 w-full h-full object-cover object-center z-0" loading="lazy" />
        </div>
                          ...
                          <div className="relative h-full w-full">
                            ...
                            <div className="absolute left-2 bottom-2">
                              ...
                              <button className="bg-white py-[2px] px-1 text-[#1772ea] font-semibold text-[7px] rounded-[22px] flex mt-2 items-center">
                                Watch video{" "}
                                <img src="https://ik.imagekit.io/mileseducation/miles_website/accounting/cpa-visit/play.webp" alt="play" className="ml-1 w-3 h-3" width={16} height={16} />
                              </button>
                            </div>
                          </div>
                        </div>
  ...
  return (
    <>
      ...
      <div className="w-full bg-[#061A2F] px-4 py-8 relative lg:hidden">
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="flex justify-center items-center">
            <img src="https://ik.imagekit.io/mileseducation/miles_website/accounting/cpa/gameplan_mobileNew.webp" alt="gameplan cpa" width={328} height={494} className="w-full h-full" />
          </div>
      ...
      <div className="w-full bg-[#051A30] relative hidden lg:block">
        <img src="https://ik.imagekit.io/mileseducation/miles_website/accounting/cpa-salary/cpaLicenceBG.webp" alt="" className="absolute inset-0 w-full h-full object-cover object-center z-0" loading="lazy" />
...
function CPAExamFee() {
  return (
    <div className="w-full relative">
      <img src="https://ik.imagekit.io/mileseducation/miles_website/accounting/cpa/cpaExamBG.png?tr=f-webp" alt="Background graphic for Miles Education" className="absolute inset-0 w-full h-full object-cover z-0 hidden md:block" loading="lazy" />
            ...
            {testimonialData.slice(currentIndex, currentIndex + visibleCount).map((t, idx) => (
              <div key={idx} className="flex-shrink-0 w-full md:w-[calc(33.33%-12px)] bg-white rounded-2xl border border-gray-200 shadow-[0_0_12px_0_rgba(4,84,175,0.12)] p-4 flex flex-col gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <img src={t.compLogo} alt="company" className="h-8 w-auto object-contain" loading="lazy" />
                </div>
...
function PanIndiaPresence() {
  ...
  return (
    <div className="w-full bg-white relative">
      <img src="https://ik.imagekit.io/mileseducation/miles_website/accounting/cpa/panIndia.png?tr=f-webp" alt="Miles Logo Background" className="absolute inset-0 w-full h-full object-cover z-0" loading="lazy" />
